...
class WareHouseAdminAllProduct extends StatelessWidget {
  const WareHouseAdminAllProduct({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("All Product", style: TextStyle(color: Colors.white)),
