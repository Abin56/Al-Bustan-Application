...
class WareAdminDeliveryOrders extends StatelessWidget {
  const WareAdminDeliveryOrders({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
        title: const Text("Delivery Orders", style: TextStyle(color: Colors.white)),
