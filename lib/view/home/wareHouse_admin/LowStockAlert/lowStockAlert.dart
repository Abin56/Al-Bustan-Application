...
class WareAdminLowCostAlert extends StatelessWidget {
  const WareAdminLowCostAlert({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
        title: const Text("Low Cost Alert", style: TextStyle(color: Colors.white)),
