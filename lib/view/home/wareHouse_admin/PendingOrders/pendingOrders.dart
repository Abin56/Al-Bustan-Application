...
class wareAdminPendingOrders extends StatelessWidget {
  const wareAdminPendingOrders({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(  appBar: AppBar(
        title: const Text("Pending Orders", style: TextStyle(color: Colors.white)),
