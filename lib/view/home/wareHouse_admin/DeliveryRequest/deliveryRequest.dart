...
class wareAdminDeliveryRequest extends StatelessWidget {
  const wareAdminDeliveryRequest({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Delivery Request", style: TextStyle(color: Colors.white)),
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              width: 150,
                              color: Colors.blue[50],
                              child: const Center(child: SingleChildScrollView(child: Text("Apple"))),
                            ),
                            Padding(
