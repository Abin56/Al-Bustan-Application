...
class WareAdminPickedOrders extends StatelessWidget {
  const WareAdminPickedOrders({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
        title: const Text("Picked Orders", style: TextStyle(color: Colors.white)),
